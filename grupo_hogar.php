        ...
        <tr> 
          ...
          <tr>
            ...
            <td colspan="1">
              ...
              <br><input type="number" min="2" max="10"  onkeypress="return check(event,value)" oninput="checkLength()" onkeydown="return tab_btn(event,getElementById('rel_parentesco'),getElementById('sexo'))"  style="width: 80%;" name="rel_parentesco" id="rel_parentesco" value="<?php print $rel_parentesco ?>" <?php print $leer ?> <?php print $cv2 ?> required>
            ...
            <td colspan="1">
              <br><input type="number" name="cober_medic" id="cober_medic" value="<?php print $cober_medic ?>"required  oninput="checkLength5()" onkeydown="return tab_btn(event,getElementById('cober_medic'),getElementById('salud_1'))" class="lij3" <?php print $cv2 ?> <?php print $cv1 ?>>
            </td>
            <td colspan="1" >
              <br><input type="number" style="width: 80%;"  name="salud_1" id="salud_1" class="lij2"  value="<?php print $salud_1 ?>" onkeypress="return check(event,value)" oninput="checkLength6()" onkeydown="return tab_btn(event,getElementById('salud_1'),getElementById('salud_2'))"  required min="1" max="9" <?php print $cv2 ?> <?php print $cv1 ?>>
            </td>
            <td colspan="1" style="width: 7%">

              <br><input type="number" name="salud_2" id="salud_2" value="<?php print $salud_2 ?>" required  onkeypress="return check(event,value)" oninput="checkLength7()" onkeydown="return tab_btn(event,getElementById('salud_2'),getElementById('disc_1'))"  class="sinotre" <?php print $cv2 ?> <?php print $cv1 ?>>
            </td>
            <td colspan="1" style="width: 8%"><b>
              <br><input type="number" placeholder="" name="disc_1" id="disc_1" style="width: 10%;"  value="<?php print $disc_1 ?>"  required onkeypress="return check(event,value)" oninput="checkLength8()" onkeydown="return tab_btn(event,getElementById('disc_1'),getElementById('disc_10'))"  class="sin" <?php print $cv2 ?> <?php print $cv1 ?>>

              <input type="number" placeholder="" name="disc_10" id="disc_10" style="width: 10%;"  value="<?php print $disc_10 ?>" required onkeypress="return check(event,value)" oninput="checkLength9()" onkeydown="return tab_btn(event,getElementById('disc_10'),getElementById('disc_100'))" class="sin" <?php print $cv2 ?> <?php print $cv1 ?>>

              <input type="number" placeholder="" name="disc_100" id="disc_100" style="width: 10%;"  value="<?php print $disc_100 ?>" required onkeypress="return check(event,value)" oninput="checkLength10()" onkeydown="return tab_btn(event,getElementById('disc_100'),getElementById('disc_1000'))" class="sin" <?php print $cv2 ?> <?php print $cv1 ?>>

              <input type="number" placeholder="" name="disc_1000" id="disc_1000" style="width: 10%;"  value="<?php print $disc_1000 ?>" required onkeypress="return check(event,value)" oninput="checkLength11()" onkeydown="return tab_btn(event,getElementById('disc_1000'),getElementById('disc_10000'))"  class="sin" <?php print $cv2 ?> <?php print $cv1 ?>>

              <input type="number" placeholder="" name="disc_10000" id="disc_10000" style="width: 10%;"  value="<?php print $disc_10000 ?>" required onkeypress="return check(event,value)" oninput="checkLength12()" onkeydown="return tab_btn(event,getElementById('disc_10000'),getElementById('disc_100000'))" class="sin" <?php print $cv2 ?> <?php print $cv1 ?>>

              <input type="number" placeholder="" name="disc_100000" id="disc_100000" style="width: 10%;"  value="<?php print $disc_100000 ?>" required onkeypress="return check(event,value)" oninput="checkLength12_1()" onkeydown="return tab_btn(event,getElementById('disc_100000'),getElementById('disc_2'))"  class="sin" <?php print $cv2 ?> <?php print $cv1 ?>>
            </b></td>

            <td colspan="1">
              <br><input type="number" placeholder="" name="disc_2" id="disc_2" value="<?php print $disc_2 ?>" required onkeypress="return check(event,value)" oninput="checkLength13()" onkeydown="return tab_btn(event,getElementById('disc_2'),getElementById('jub_1'))"  class="sin" <?php print $cv2 ?> <?php print $cv1 ?>>
            </td>
           
            <td colspan="1" style="width: 7%">
              <br><input type="number" name="jub_1" id="jub_1"  value="<?php print $jub_1 ?>" required onkeypress="return check(event,value)" oninput="checkLength14()" onkeydown="return tab_btnq(event,getElementById('jub_1'),getElementById('jub_2'),getElementById('edu_1'))" class="sin"  <?php print $cv2 ?> <?php print $cv1 ?>>
            </td>
            <td colspan="1">
              <br><input type="text" name="jub_2" id="jub_2"  value="<?php print $jub_2 ?>" onkeypress="return check(event,value)" oninput="checkLength15()" onkeydown="return tab_btn(event,getElementById('jub_2'),getElementById('edu_1'))" class="sino1"  <?php print $cv2 ?> <?php print $cv1 ?>>
            </b></td>
            <td colspan="1">
              <br><input type="number" name="edu_1" id="edu_1"  value="<?php print $edu_1 ?>" required onkeypress="return check(event,value)" oninput="checkLength16()" onkeydown="return tab_btnl(event,getElementById('edu_1'),getElementById('edu_2'),getElementById('submitguardar'),getElementById('edu_3'),getElementById('edu_4'))" class="sinotre" <?php print $cv2 ?> <?php print $cv1 ?>>
            </td>
            <td colspan="1">
              <br><input type="text" name="edu_2" id="edu_2"  value="<?php print $edu_2 ?>" onkeypress="return check(event,value)" oninput="checkLength17()" onkeydown="return tab_btn(event,getElementById('edu_2'),getElementById('edu_3'))"  class="sinonueve"  <?php print $cv2 ?> <?php print $cv1 ?>>
            </td>
            <td colspan="1">
              <br><input type="text" name="edu_3" id="edu_3"  value="<?php print $edu_3 ?>" onkeypress="return check(event,value)" oninput="checkLength18()" onkeydown="return tab_btno(event,getElementById('edu_3'),getElementById('edu_4'),getElementById('submitguardar'))"  class="sin" <?php print $cv2 ?> <?php print $cv1 ?>>
            </td>
            <td colspan="1">
              <br><input type="text" name="edu_4" id="edu_4"  value="<?php print $edu_4 ?>" onkeypress="return check(event,value)" oninput="checkLength19()" onkeydown="return tab_btn(event,getElementById('edu_4'),getElementById('submitguardar'))"  class="entero" <?php print $cv2 ?> <?php print $cv1 ?>>
            </td>
...
{ 
  ...
  .'<td colspan=2><a href="grupo_hogar.php?Id='.$row['id_exp'].'&mtri='.$row['id_numero'].'">Modificar</a></td>'
  .'</tr>';
  }
  else{
  include './ifhogar.php';
  ...
  .'<td><a href="grupo_hogar.php?Id='.$row['id_exp'].'&mtri='.$row['id_numero'].'">Modificar</a></td>'
 .'<td><a href="javascript:;" onclick= avisom("grupo_hogar.php?Id='.$row['id_exp'].'&brId='.$row['id_numero'].'","'.$row['id_numero'].'");>Eliminar</a></td>' 
...
<div id="cuerpo" style="display: <?php print $seguir ?>;">
    ...
    <form method="POST" action="grupo_hogar.php?Id=<?php print $id_exp ?>" autocomplete="off"> 
        ...
        <br></br>
        <input type="button" id="bon" value="Cargar Observación" onclick="bos()" style=" display:<?php print $tus ?> ;margin-left:auto;margin-right: auto;"><br>
        ...
        <h3 style="text-align: center;"><u></b>Observaciones<b></u></h3>
            ...
            <input type="submit" style=" display: block;margin-left:auto;margin-right: auto;" name="submita" id="submitguardar" value ="<?php echo $value ?>">
        </div>
        </form>
    </div>
...
<th></th>';
    ...
    while ($row=  pg_fetch_array($Nuevocomentariohogar)) // recorre los identificaciones uno por uno hasta el fin de la tabla
    {
       print '<tr>'
       .'<td>'.$row['comen'].'</td>'                   
       .'<td><a href="grupo_hogar.php?Id='.$row['id_exp'].'&mdIde='.
       $row['id_comentariohogar'].'">Modificar</a></td>'
        //                  .'<td><a href="javascript:;" onclick= avisoi("Salida_Mes.php?brId='.$row['id_salida_mes'].'","'.$row['mes'].'");>Borrar</a></td>'                
        //                  .'<td><a href="javascript:;" onclick= avisoj("Salida_Mes.php?crId='.$row['id_salida_mes'].'","'.$row['mes'].'");>Cerrar Salida</a></td>'                  
       .'</tr>';
   }
