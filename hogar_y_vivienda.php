 ...
 <table border="2">
        ...
        <tr><th colspan="3"><p></p></th>
            <tr>
                ...
                <td style="width:4%;border-right: none;" rowspan="1" style="background-color: #8acdf9;"><input style="width: 100%;padding: 0px 0px 0px 0px;"  name="p1" id="p1" type="text" class="sino1" maxlength="1" required value="<?php print $p1 ?>" <?php print $dis1 ?> onkeydown="return tab_btn(event,getElementById('p1'),getElementById('p2'))" oninput="checkLength1()">   
                </td>
            ...
            <tr>
                ...
                <td style="width:4%;border-right: none" rowspan="1" style="background-color: #8acdf9;">
                    <input type="text" style="width: 80%" class="sino2" maxlength="1" name="p2" id="p2" required=""  value="<?php print $p2 ?>" oninput="checkLength2()" <?php print $dis?> onkeydown="return tab_btn1(event,getElementById('p2'),getElementById('p3'),getElementById('p4'))">  
                </td>
                <td style="width:40%;border-left:none"> 
            ...
            <tr>
                ...
                <td style="width:4%;border-right: none" style="background-color: #8acdf9;">
                    <input name="p3" id="p3" type="text" maxlength="1" class="sin" style="width: 80%" value="<?php print $p3 ?>" oninput="checkLength3()" <?php print $dis?> onkeydown="return tab_btn(event,getElementById('p3'),getElementById('p4'))">
                </td>
              <td style="width:40%;border-left:none"> 
            ...
            <tr>
                ...
                <td style="width:4%;border-right: none" rowspan="1" style="background-color: #8acdf9;">
                     <input style="width: 80%" name="p4" id="p4" type="text" maxlength="1"  class="sinocin" required value="<?php print $p4 ?>" oninput="checkLength4()" <?php print $dis?> onkeydown="return tab_btn(event,getElementById('p4'),getElementById('p5'))"  >
                </td>
                <td style="width:40%;border-left:none"> 
            ...
            <tr>
                ...
                <td style="width:4%;border-right: none" style="background-color: #8acdf9;">
                   <input name="p5" id="p5"  type="text" maxlength="1" class="sin" required value="<?php print $p5 ?>" style="width: 80%" 
            ...
            <tr>
                ...
                <td style="width:4%;border-right: none" rowspan="1" style="background-color: #8acdf9;">
                   <input type="text" style="width: 80%"  maxlength="1"  name="p6" id="p6" class="sinotre" required="" value="<?php print $p6 ?>" oninput="checkLength6()" <?php print $dis?> onkeydown="return tab_btn(event,getElementById('p6'),getElementById('p7'))" >
                </td>
                <td style="width:40%;border-left:none"> 
            ...
            <tr>
                ...
                <td style="width:4%;border-right: none" rowspan="1" style="background-color: #8acdf9;">
                 <input type="text" maxlength="1" class="sinocin" name="p7" id="p7" required value="<?php print $p7 ?>" oninput="checkLength7()" style="width: 80%" <?php print $dis?> onkeydown="return tab_btn(event,getElementById('p7'),getElementById('p8'))"> 
                </td>
                <td style="width:40%;border-left:none"> 
            ...
            <tr>
                ...
                <td style="width:4%;border-right: none" rowspan="1" style="background-color: #8acdf9;">
                 <input class="sinotre" type="text" maxlength="1" name="p8" id="p8" required value="<?php print $p8 ?>" oninput="checkLength8()" style="width: 80%" <?php print $dis?> onkeydown="return tab_btn2(event,getElementById('p8'),getElementById('p9'),getElementById('p10'),getElementById('p11'),getElementById('p12'))"> 
                </td>
                <td style="width:40%;border-left:none"> 
            ...
            <tr>
                ...
                <td style="width:4%;border-right: none" rowspan="1" style="background-color: #8acdf9;">
                 <input type="text" class="sinotre" maxlength="1"  name="p9" id="p9" value="<?php print $p9 ?>" oninput="checkLength9()" onkeydown="return tab_btn(event,getElementById('p9'),getElementById('p10'))" style="width: 80%" <?php print $dis?>> 
                </td>
                <td style="width:40%;border-left:none"> 
            ...
            <tr>
                ...
                <td style="width:4%;border-right: none" rowspan="1" style="background-color: #8acdf9;">
                 <input name="p10" class="sino1" id="p10" maxlength="1" type="text" value="<?php print $p10 ?>" oninput="checkLength10()" onkeydown="return tab_btn(event,getElementById('p10'),getElementById('p11'))" style="width: 80%" <?php print $dis?>>
                </td>
                <td style="width:40%;border-left:none"> 
           ...
           <tr><th colspan="3"><p></p></th>
            ...
            <tr>
                ...
                <td style="width:4%;border-right: none" rowspan="1" style="background-color: #8acdf9;">
                <input type="text" maxlength="1" class="sin" name="p11" id="p11" value="<?php print $p11 ?>" oninput="checkLength11()" onkeydown="return tab_btn(event,getElementById('p11'),getElementById('p12'))" style="width: 80%" <?php print $dis?> >
                </td>
                <td style="width:40%;border-left:none"> 
            ...
            <tr>
                ...
                <td style="width:4%;border-right: none" rowspan="1" style="background-color: #8acdf9;">
               <input type="text" class="sino1" maxlength="1" name="p12" id="p12" required="" value="<?php print $p12 ?>" onkeydown="return tab_btn(event,getElementById('p12'),getElementById('p13'))" oninput="checkLength12()" style="width: 80%" <?php print $dis?>>
                </td>
                <td style="width:40%;border-left:none"> 
            ...
            <tr>
                ...
                <td style="width:4%;border-right: none" rowspan="1" style="background-color: #8acdf9;">
              <input type="text" maxlength="1" name="p13" id="p13" class="sinocin" required value="<?php print $p13 ?>" oninput="checkLength13()" onkeydown="return tab_btn(event,getElementById('p13'),getElementById('p14'))" style="width: 80%" <?php print $dis?> >
                </td>
                <td style="width:40%;border-left:none"> 
            ...
            <tr>
                ...
                <td style="width:4%;border-right: none" rowspan="1" style="background-color: #8acdf9;">
            <input type="text" maxlength="1" name="p14" id="p14" class="sinocin" required="" value="<?php print $p14 ?>" oninput="checkLength14()" onkeydown="return tab_btn(event,getElementById('p14'),getElementById('p15'))" style="width: 80%" <?php print $dis?>>
                </td>
                <td style="width:40%;border-left:none"> 
              ...
              <tr><th colspan="3"><p></p></th>
                ...
                <td style="width:4%;border-right: none" rowspan="1" style="background-color: #8acdf9;">
                <input type="text" maxlength="2" class="entero" name="p15" id="p15" required="" value="<?php print $p15 ?>" oninput="checkLength15()" onkeydown="return tab_btn(event,getElementById('p15'),getElementById('p16'))" style="width: 80%" <?php print $dis?>>
                </td>
                <td style="width:40%;border-left:none"> 
            ...
            <tr><th colspan="3"><p></p></th>
                ...
                <td style="width:4%;border-right: none" rowspan="1" style="background-color: #8acdf9;">
               <input type="text" maxlength="2" name="p16" id="p16" required value="<?php print $p16 ?>" oninput="checkLength16()" onkeydown="return tab_btn(event,getElementById('p16'),getElementById('p17'))" style="width: 80%" <?php print $dis?>>
                </td>
                <td style="width:40%;border-left:none"> 
              ...
              <tr><th colspan="3"><p></p></th>
                ...
                <td style="width:4%;border-right: none" rowspan="1" style="background-color: #8acdf9;">
               <input type="text" maxlength="1" name="p17" id="p17" class="sinonueve" required value="<?php print $p17 ?>" oninput="checkLength17()" onkeydown="return tab_btn(event,getElementById('p17'),getElementById('p18'))" style="width: 80%" <?php print $dis?>>
                </td>
                <td style="width:40%;border-left:none"> 
              <textarea style="width:95%" name="dp17" id="dp17" cols="1" rows="3" disabled><?php print $dp17 ?></textarea>
               ...
               <tr><th colspan="3"><p></p></th>
                ...
                <td style="width:4%;border-right: none" rowspan="1" style="background-color: #8acdf9;">
              <input type="text" maxlength="1" name="p18" id="p18" onkeyup="wipe()" class="sino2" required="" value="<?php print $p18 ?>" oninput="checkLength18()" style="width: 80%" <?php print $dis?> onkeydown="return tab_btn3(event,getElementById('p18'),getElementById('p19'))" >
                </td>
                <td style="width:40%;border-left:none"> 
            ...
            <tr><th colspan="3"><p></p></th>
                ...
                <td style="width:4%;border-right: none" rowspan="1" style="background-color: #8acdf9;">
              <input type="text" maxlength="1" name="p19" id="p19" class="sin" required value="<?php print $p19 ?>"  oninput="checkLength19()" onkeydown="return tab_btn(event,getElementById('p19'),getElementById('p20'))" style="width: 80%" <?php print $dis?>>
                </td>
                <td style="width:40%;border-left:none"> 
              ...
              <tr><th colspan="3"><p></p></th>
                ...
                <td style="width:4%;border-right: none" rowspan="1" style="background-color: #8acdf9;">
              <input type="text" maxlength="1" name="p20" id="p20" class="sinocin" required  value="<?php print $p20 ?>" oninput="checkLength20()" onkeydown="return tab_btn(event,getElementById('p20'),getElementById('submitguardar'))"style="width: 80%" <?php print $dis?>>
                </td>
                <td style="width:40%;border-left:none"> 
              <textarea style="width:95%" name="dp20" id="dp20" cols="1" rows="3" disabled><?php print $dp20 ?></textarea>
                ...
                <td colspan="<?php print $bn ?>" id="boton">
                   ...
                   <input type="submit" name="submit" id="submitguardar" value ="<?php echo $value ?>" <?php print $dis ?> style="width:18%;<?php print $car ?>"  >
...
while ($row=  pg_fetch_array($NuevoIndicador)) // recorre los identificaciones uno por uno hasta el fin de la tabla
{
   ...
   print '<td colspan="2"><a href="hogar_y_vivienda.php?Id='.$row['id_exp'].'&mdIdi='.$row['id_hv'].'">Modificar</a>';
    print               
    '  &nbsp&nbsp<a href="javascript:;" onclick= avisof("hogar_y_vivienda.php?Id='.$row['id_exp'].'&brId='.$row['id_exp'].'","'.$row['id_exp'].'");>Eliminar Ficha</a>';
     print               
    
       '&nbsp &nbsp<a href="javascript:;" onclick="redirect()">Principal</a></td>';
