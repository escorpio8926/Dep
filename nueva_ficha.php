...
<form method="POST" action="nueva_ficha.php" autocomplete="off">
    ...
    <tr>
        ...
        <th colspan="1"  style="text-align: right;">
            Calle:<input type="text" class="texto" style="width: 76%" name="calle" id="calle"  value = "<?php print $calle ?>" tabindex="5" oninput="checkLengthe()" onkeydown="return tab_btn1(event,getElementById('calle'),getElementById('nro'))" disabled required>
        </th>
        <th colspan="1"  style="text-align: justify;">
    ...
    <tr>
        ...
        <th class="cantidad" colspan="1"  style="text-align: right;">
            Piso:<input type="text" class="numero" style="width: 76%"  name="piso" id="piso" class="cantidad" value="<?php print $piso ?>" tabindex="7" onkeydown="return tab_btn11(event,getElementById('piso'),getElementById('dpto'))" disabled>
        </th>
        <th colspan="1"  style="text-align: justify;">
