...
<form method="POST" action="nueva_ficha.php" autocomplete="off">
    ...
    <tr>
        ...
        <th colspan="1"  style="text-align: justify;">
           &nbsp;&nbsp; Nro:&nbsp; <input type="text" class="entero" style="width: 40%"  maxlength="10" name="nro" id="nro"  value = "<?php print $nro ?>" tabindex="6"  onkeydown="return tab_btn2(event,getElementById('nro'),getElementById('barrio'),getElementById('piso'))" disabled>
        </th>
    ...
    <tr>
        ...
        <th colspan="1"  style="text-align: justify;">
            &nbsp;&nbsp;Dpto: <input type="text" class="texto" style="width: 40%"  name="dpto" id="dpto"  value ="<?php print $dpto ?>" onkeydown="return tab_btn1(event,getElementById('dpto'),getElementById('barrio'))" tabindex="8" disabled>
        </th>
